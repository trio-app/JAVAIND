...
<html lang="en">
  <head>
    ...
    <title>DOLPHIN HTML5 TEMPLATE</title>
    ...
    <!-- Dolphin style sheet -->
    <link rel="stylesheet" href="assets/css/weblysleek-ui-fonts.css">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">
            ...
            <span class="text--bold">dolphin</span>
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#" class="btn btn-icon btn-round"><span class="btn-icon-container"><i class="lnr lnr-download"></i></span></a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="featured-image-container">
              <img class="max-width-100" src="assets/images/featured-vector.png" alt="">
            </div>
          </div>
          <div class="col-md-6">
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="testimonial-container">
                      ...
                      <div class="testimonial-content">
                        <p class="testimonial-speech"><img class="img-qoute" src="assets/images/quate.png" alt="">Welcome to one of the world’s largest creative communities and the number one game development platform.Unity gives you everything.You need to realize your creative vision fast, and move ahead.</p>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section id="workflow" class="section padding-top-bottom-65">
      <div class="row absolute-image-container">
        <div class="col-md-6 col-md-offset-6">
          <img class="max-width-100" src="assets/images/workflow.png" alt="">
        </div>
      </div>
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo1.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo2.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo3.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo4.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo5.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
          <div class="col-md-4 col-sm-6 ">
            <img src="assets/images/logo6.png" alt="" class="img-responsive max-width-100 max-height-60 padding-15 align--center">
          </div>
        </div>
    ...
    <section id="blog" class="section section-news">
      <div class="container">
        ...
        <div id="blog-carousel" class="owl-carousel">
          <div>
            <div class="news-card">
              <img src="assets/images/blog1.png" alt="" class="img-responsive max-width-100">
          ...
          <div>
            <div class="news-card">
              <img src="assets/images/blog2.png" alt="" class="img-responsive max-width-100">
              <div class="news-content">
          ...
          <div>
            <div class="news-card">
              <img src="assets/images/blog3.png" alt="" class="img-responsive max-width-100">
              <div class="news-content">
